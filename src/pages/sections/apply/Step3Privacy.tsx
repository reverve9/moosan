...
export default function Step3Privacy({ form, updateForm, onPrev, onSubmit }: Props) {
      ...
      <div className={styles.card}>
        ...
        <div className={styles.notice}>
          <ul className={styles.rulesList}>
            <li>본 참가자는 대회 일정 및 운영 방침을 준수합니다.</li>
            <li>참가 신청에 기재한 내용은 사실과 다를시 심사에서 제외되며,
                위부 사항이 확인될 경우 참가가 취소될 수 있습니다.</li>
            <li>대회 당일 준비물 및 시간에 맞게 도착하여야 하며,
                관련 운영 변경시 사전 안내는 참가자에게만 진행됩니다.</li>
            <li>대회 입장 리허설 및 본 공연 시간은 대회의 사정에 따라 변경 가능하며,
                상세 내용은 문자발송이 진행됩니다.</li>
            <li>천재지변, 감염병, 기타 불가항력적 사유 발생 시
                대회 일정 및 방식이 변경될 수 있습니다.</li>
            <li>대회 시 촬영된 사진 및 영상은 기록, 홍보, 보도 자료를 위해
                비상업적 목적으로 활용됩니다.</li>
          </ul>
        </div>
        <Checkbox
